...
export default function AnalyzeSection({ goBackToUpload, goToAnalyzing }: { goBackToUpload: () => void; goToAnalyzing: () => void }) {
    return (
        <div className="flex flex-col gap-8">
            ...
            <div className="flex gap-6">
                <div className="flex-1 flex flex-col border border-gray-300 rounded-2xl h-[500px] overflow-hidden">
                    <div className="min-h-[80px] border-b-1 border-b-gray-300 flex items-center px-6 justify-between">
                        <div className="flex flex-col gap-1">
                            ...
                            <span className="text-sm flex items-center gap-2 text-gray-500">
                                <FileText className="w-4 h-4" /> filename.pdf
                            </span>
                        </div>
                    ...
                    <div className="flex-1 min-h-0 min-w-0">
                        <Textarea className="w-full h-full min-w-0 max-w-full resize-none rounded-none! border-0! outline-none! ring-0! p-4" />
                    </div>
                </div>
                <div className="flex-1 flex flex-col border border-gray-300 rounded-2xl h-[500px] overflow-hidden">
                    ...
                    <div className="flex-1 min-h-0 min-w-0">
                        <Textarea className="w-full h-full resize-none rounded-none! border-0! outline-none! ring-0! p-4" placeholder="Paste the job description here..." />
                    </div>
                </div>
            </div>
            <div className="flex items-center justify-between">
                ...
                <Button className="" variant={"default"} onClick={goToAnalyzing}>
